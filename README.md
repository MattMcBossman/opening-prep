...
- `mobile-plan.md` — active implementation plan for mobile-first Explorer, repertoire management, drills, accessibility, and real-device verification.
