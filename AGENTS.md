...
### Must review before Phase 4
Before starting Phase 4, review and resolve these Phase 2/3 design notes:
...
- **PGN import/export with RAV support.** Support importing and exporting repertoire trees as PGNs with Recursive Annotation Variations (RAV) so branch lines round-trip through common chess tools. Since PGN/RAV is move-order-tree based and does not natively preserve transposition/shared-position graph identity, export should duplicate transposed continuations as needed and may include FEN comments for custom re-linking on import.
